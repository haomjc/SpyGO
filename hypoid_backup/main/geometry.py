...
def pinion_conjugate_to_gear(data, flank, zRgear, EPGalpha, triplets_gear, interpolated_triplets_pin, offset_psi):

    hypoid_offset = data['SystemData']['hypoidOffset']
    HAND = data['SystemData']['HAND']
    ratio = data['SystemData']['ratio']
    shaft_angle = data['SystemData']['shaft_angle']*np.pi/180
