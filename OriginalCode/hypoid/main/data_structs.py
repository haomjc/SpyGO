...
# dataclasses for gear/pinion concave/convex data attributes of Hypoid object (surface points, triplets, etc)
@dataclass
class flankData:
...
# identification problem data struct
@dataclass
class identificationProblemData:
    designData: DesignData = field(default_factory=DesignData)
    gear: flankData = field(default_factory=flankData)
    pinion: flankData = field(default_factory=flankData)
    interpTriplets: object = field(default_factory=FlankNumericalData)
