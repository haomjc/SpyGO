...
def mid_point_element(r, s, nodes):
    # given arrays of r and s coordinates (or u and v) and the node coordinates it yields internal points
...
def chebyshev_interpolation_casadi(fun, N, funlims):
    ...
    Parameters:
    fun : function to interpolate (casadi function or callable) or values at Chebyshev nodes
